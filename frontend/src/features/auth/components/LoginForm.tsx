    ...
    <div style={styles.root}>
      ...
      <div style={styles.card}>
        ...
        <input
          ...
          value={payload.code}
          onChange={(e) => setPayload((p: LoginPayload) => ({ ...p, code: e.target.value }))}
        ...
        <input
          ...
          value={payload.alias}
          onChange={(e) => setPayload((p: LoginPayload) => ({ ...p, alias: e.target.value }))}
...
const styles: Record<string, CSSProperties> = {
  ...
  titleRow: { textAlign: "center", marginBottom: 6 },
  title: {
    fontSize: 28,
    fontWeight: 700,
    color: "#e8f5e8",
